      ...
      window, e.exports = function (e) {
        ...
        function C(e, t) {
          ...
          this.runActions = function (e, o) {
            a[t].classList.add(x), i[t].classList.add(m), s[t].removeChild(s[t].firstChild), l(e, o), n.runActions = l;
          };
        }
        ...
        function z(e, t) {
          ...
          e.props.sources, o[t] = document.createElement("div"), o[t].className = "".concat(r, "invalid-file-wrapper ").concat(c), o[t].innerHTML = "Invalid source", i[t].classList.add(m), i[t].appendChild(o[t]), s[t].removeChild(s[t].firstChild);
        }
        ...
        function K(e) {
          ...
          n = (t = e).core.classFacade, o = t.elements, n.removeFromEachElementClassIfContains = function (e, t) {
            ...
            var t,
                ...
                p = e.stageIndexes,
                f = (t = function t() {
              s.removeFromEachElementClassIfContains("sourceAnimationWrappers", g);
            }, n = [], function () {
            ...
            a.changeTo = function (e) {
              ...
              var t = p.current;
              a.changeTo(e), s.removeFromEachElementClassIfContains("sourceMainWrappers", u), B(d[t], m), B(d[t], h), d[t].classList.add(g), B(d[e], m), B(d[e], g), d[e].classList.add(h), f(), o[e].zero(), setTimeout(function () {
        ...
        function Q(e) {
          ...
          n.isInitialized = !0, n.scrollbarWidth = function (e) {
          ...
          }(e), K(e), o.container = document.createElement("div"), o.container.className = "".concat(r, "container ").concat(a, " ").concat(m), function (e) {
            var t = e.elements;
            ...
            for (var t = e.props.sources, n = e.resolve, o = n(w), r = n(P), i = n(H, [o, r]), s = 0; s < t.length; s++) {
